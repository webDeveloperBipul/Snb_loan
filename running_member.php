...
<!-- ==================================================== -->
        ...
        <div class="container-fluid">
          ...
          <h4 class="mb-0">বর্তমান সদস্য</h4>
          
            <a href="comity.php" class="d-none ml-auto mt-2 d-sm-inline-block btn btn-sm btn-primary shadow-sm">কমিটি</a>
            <a href="paid_member.php" class="d-none ml-3 mt-2 d-sm-inline-block btn btn-sm btn-primary shadow-sm">পরিশোধকৃত</a>
        ...
        <div class="col-md-12">
            <div class="row mb-3 bg-dark">
                ...
                <h5 class="text-warning" >বর্তমান সদস্য :
                              ...
                              <?php
              $sql = "SELECT * FROM all_member_form_data where not is_paid='yes_paid' ORDER BY id";
...
if ($res->num_rows > 0) {
    ...
    $image = $row["image"];
        ...
        echo "<tr>              
                                ...
                                <a class='btn btn-danger btn-sm btn-delete' value='1' name='actiondelete' Onclick='return ConfirmDelete();' id='alert'  href='action/delete.php?id=" . $row["id"] .  "&image=". $image ."'>ডিলিট</a>
                                </td></tr>";
